...
public class LeaveController {
    ...
    @Operation(summary = "Approve or reject leave", description = "Allowed roles: ADMIN, HR, EMPLOYEE")
    ...
    @GetMapping("/pending")
    @Operation(summary = "List pending leave requests", description = "Allowed roles: ADMIN, HR, EMPLOYEE")
    public List<LeaveRequestResponse> getPendingRequests() {
        return leaveService.getPendingRequests();
    }

    @GetMapping("/pending/page")
    @Operation(summary = "List pending leave requests (paged)", description = "Allowed roles: ADMIN, HR, EMPLOYEE")
